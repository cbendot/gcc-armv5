...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/builds/bootlin/toolchains-builder/build/armv5-eabi--glibc--bleeding-edge-2021.11-1/arm-buildroot-linux-gnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
